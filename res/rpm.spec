...
Vendor:     uptimedesk <info@rustdesk.com>
...
case "$1" in
  ...
  2)
    # for upgrade
    systemctl stop uptimedesk || true
  ;;
esac
...
systemctl enable uptimedesk
systemctl start uptimedesk
...
case "$1" in
  0)
    # for uninstall
    systemctl stop uptimedesk || true
    systemctl disable uptimedesk || true
