...
pub const VER_TYPE_RUSTDESK_CLIENT: &str = "updesk-client";
pub const VER_TYPE_RUSTDESK_SERVER: &str = "updesk-server";

pub fn version_check_request(typ: String) -> (VersionCheckRequest, String) {
    const URL: &str = "https://updesk.uptimeservice.it/api/version/latest";
