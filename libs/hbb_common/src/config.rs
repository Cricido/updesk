...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("UpDesk".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://updesk.it/docs/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://updesk.it/docs/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str = "https://updesk.it/docs/linux/#headless-support";

lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("updesk docs home", LINK_DOCS_HOME),
        ("updesk docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("updesk x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["updesk.uptimeservice.it"];
pub const RS_PUB_KEY: &str = "tec7g45efBCxykMbBU8rozj0rVEq0Yp+Zz8MjjiN4A4=";
...
impl Config {
    ...
    pub fn get_permanent_password() -> String {
        let local = CONFIG.read().unwrap().password.clone();
        if !local.is_empty() {
            return local;
        }
        HARD_SETTINGS
