...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("uptimedesk".encode(encoding=encoding))
...
# Windows: python3 .\generate.py -f ..\uptimedesk\flutter\build\windows\runner\Debug\ -o . -e ..\uptimedesk\flutter\build\windows\runner\Debug\rustdesk.exe
