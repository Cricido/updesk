...
extension Index on int {
  WindowType get windowType {
    switch (this) {
      ...
      case 6:
        return WindowType.QuickSupport;
      default:
...
class UptimeDeskMultiWindowManager {
  UptimeDeskMultiWindowManager._();

  static final instance = UptimeDeskMultiWindowManager._();
  ...
  Future<void> openQuickSupportWindow() async {
    final msg = jsonEncode({'type': WindowType.QuickSupport.index});
    final windowController = await DesktopMultiWindow.createWindow(msg);
    windowController
      ..setFrame(const Offset(0, 0) & const Size(460, 620))
      ..center()
      ..setTitle('UptimeDesk – Assistenza');
  ...
  /// `winManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final winManager = UptimeDeskMultiWindowManager.instance;
