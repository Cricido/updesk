...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (winManager.getActiveWindows().contains(kMainWindowId)) {
        await winManager.unregisterActiveWindow(kMainWindowId);
      }
...
class TabbarTheme extends ThemeExtension<TabbarTheme> {
  ...
  static const light = TabbarTheme(
      selectedTabIconColor: Color(0xFF3CC870),
      unSelectedTabIconColor: Color(0xFFADB8C9),
      selectedTextColor: Color(0xFF1A202C),
      unSelectedTextColor: Color(0xFF5A6478),
      selectedIconColor: Color(0xFF1A202C),
      unSelectedIconColor: Color(0xFF5A6478),
      dividerColor: Color(0xFFD0D9E8),
      hoverColor: Color(0xFFE8EEF5),
      closeHoverColor: Color(0xFFD0D9E8),
      selectedTabBackgroundColor: Colors.white);

  static const dark = TabbarTheme(
      selectedTabIconColor: Color(0xFF3CC870),
      unSelectedTabIconColor: Color(0xFF4A5568),
      selectedTextColor: Color(0xFFF0F4FF),
      unSelectedTextColor: Color(0xFF8892A4),
      selectedIconColor: Color(0xFFF0F4FF),
      unSelectedIconColor: Color(0xFF8892A4),
      dividerColor: Color(0xFF252D40),
      hoverColor: Color(0xFF1E2535),
      closeHoverColor: Color(0xFF161B25),
      selectedTabBackgroundColor: Color(0xFF1E2535));
