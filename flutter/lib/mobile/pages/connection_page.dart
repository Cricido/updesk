    ...
    return updateUrl.isEmpty
        ...
        : Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Update disponibile (${stateGlobal.updateVersion.value.isEmpty ? bind.mainGetNewVersion() : stateGlobal.updateVersion.value})',
                  style: const TextStyle(
                      color: Colors.white, fontWeight: FontWeight.bold),
                ),
                if (stateGlobal.updateMandatory.value)
                  const Padding(
                ...
                if (stateGlobal.updateChangelog.value.trim().isNotEmpty)
                  Padding(
                    padding: const EdgeInsets.only(top: 6),
                    child: Text(
                      stateGlobal.updateChangelog.value.trim(),
