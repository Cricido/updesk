...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsUptimeDeskVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsUptimeDeskVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsUptimeDeskVirtualDisplays);
        }
  ...
  void edgeScrollMouse(double x, double y) async {
    ...
    if (encroachment.length2 == 0) {
      ...
      var bumpMouseSucceeded = _bumpMouseIsWorking &&
          (await winManager.call(WindowType.Main, kWindowBumpMouse,
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get UptimeDeskVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsUptimeDeskVirtualDisplays] ?? []);
  ...
  bool get isUptimeDeskIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'uptimedesk_idd';
