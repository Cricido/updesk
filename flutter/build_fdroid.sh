...
#
# Script to build F-Droid release of UptimeDesk
#
# Copyright (C) 2024, The UptimeDesk Authors
...
arm64-v8a)
	...
	UPTIMEDESK_FEATURES='flutter,hwcodec'
	;;
armeabi-v7a)
...
prebuild)
	...
	# Flutter used to compile main Uptimedesk library
	...
	# Install Flutter version for UptimeDesk library build
