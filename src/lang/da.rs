...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Dit ID"),
        ("Copy", "Kopier"),
        ("Quick Support", "Hurtig support"),
        ("Ready for assistance", "Klar til assistance"),
        ("Protected connection (end-to-end encrypted)", "Beskyttet forbindelse (end-to-end krypteret)"),
        ("Share your ID code with the technician", "Del din ID-kode med teknikeren"),
        ("Connecting to server...", "Opretter forbindelse til server..."),
        ("Online", "Online"),
        ("Offline", "Offline"),
        ...
        ("connecting_status", "Opretter forbindelse til UptimeDesk-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan UptimeDesk ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere UptimeDesk på systemet"),
        ("Click to upgrade", "Klik for at opgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For at kontrollere dit skrivebord på afstand skal du give UptimeDesk \"Access \" Rettigheder."),
        ("config_screen", "For at kunne få adgang til dit skrivebord langtfra, skal du give UptimeDesk \"skærmstøtte \" tilladelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give UptimeDesk mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [UptimeDesk Input] tjenesten."),
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep UptimeDesk background service", "Behold UptimeDesk baggrundstjeneste"),
        ("Ignore Battery Optimizations", "Ignorér betteri optimeringer"),
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn UptimeDesk appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("Show UptimeDesk", "Vis UptimeDesk"),
        ("This PC", "Denne PC"),
        ("or", "eller"),
        ("Elevate", "Elevér"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open-source driveren, og aktivere software rendering. Et genstart af UptimeDesk er nødvendigt."),
        ("Always use software rendering", "Brug altid software rendering"),
        ("config_input", "For at styre fjernskrivebordet med tastaturet, skal du give Uptimedesk rettigheder til at optage tastetryk"),
        ("config_microphone", "For at tale sammen over fjernstyring, skal du give UptimeDesk rettigheder til at optage lyd"),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC vinduet ved kørsel af UptimeDesk."),
        ...
        ("verify_uptimedesk_password_tip", "Bekræft UptimeDesk adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge UptimeDesk til at forbinde til din PC, stop med det samme, og læg på omgående."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Opgradér venligst UptimeDesk Server Pro til version {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, som kan forhindre UptimeDesk i at køre normalt."),
        ...
        ("powered_by_me", "Drives af UptimeDesk"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af UptimeDesk med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis UptimeDesk vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper på at UptimeDesk baggrundstjenesten kører"),
        ...
        ("About UptimeDesk", "Om UptimeDesk"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Opgrader venligst UptimeDesk-klienten til version {} eller nyere på fjernsiden!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
