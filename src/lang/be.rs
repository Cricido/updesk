...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Ваш ID"),
        ("Copy", "Капіяваць"),
        ("Quick Support", "Хуткая падтрымка"),
        ("Ready for assistance", "Гатоў да дапамогі"),
        ("Protected connection (end-to-end encrypted)", "Абароненае злучэнне (зашыфраванае)"),
        ("Share your ID code with the technician", "Падзяліцеся кодам ID з тэхнікам"),
        ("Connecting to server...", "Злучэнне з серверам..."),
        ("Online", "У сетцы"),
        ("Offline", "Не ў сетцы"),
        ...
        ("connecting_status", "Падключэнне да сеткі UptimeDesk..."),
        ...
        ("install_tip", "У некаторых выпадках UptimeDesk можа працаваць няправільна на аддаленым вузле з-за UAC. Каб пазбегнуць магчымых праблем з UAC, націсніце кнопку ніжэй для ўстаноўкі UptimeDesk у сістэме."),
        ("Click to upgrade", "Абнавіць"),
        ("Configure", "Наладзіць"),
        ("config_acc", "Каб аддаленна кіраваць сваім працоўным сталом, вам неабходна дазволіць UptimeDesk правы доступу."),
        ("config_screen", "Для аддаленага доступу да працоўнага сталу вам неабходна дазволіць UptimeDesk правы здымку экрана."),
        ...
        ("android_input_permission_tip1", "Каб аддалёная прылада магла кіраваць вашай Android-прыладай з дапамогай мышы або націсканняў, неабходна дазволіць UptimeDesk выкарыстоўваць паслугу \"Асаблівыя магчымасці\"."),
        ("android_input_permission_tip2", "Зайдзіце на адпаведную старонку сістэмных налад, знайдзіце і ўступіце ў \"Устаноўленыя паслугі\", уключыце паслугу \"UptimeDesk Input\"."),
        ...
        ("Language", "Мова"),
        ("Keep UptimeDesk background service", "Захаваць фонавую службу UptimeDesk"),
        ...
        ("Show UptimeDesk", "Паказаць UptimeDesk"),
        ...
        ("config_input", "Каб кіраваць аддаленым працоўным сталом праз клавіятуру, неабходна дазволіць UptimeDesk маніторынг уводу."),
        ("config_microphone", "Каб размаўляць з аддаленай старонкай, неабходна дазволіць UptimeDesk запіс аўдыё."),
        ...
        ("still_click_uac_tip", "Дагэтуль патрэбна, каб аддалены карыстальнік націснуў \"OK\" ў акне UAC пры запуску UptimeDesk."),
        ...
        ("verify_uptimedesk_password_tip", "Пацвердзіць пароль UptimeDesk"),
        ...
        ("scam_text1", "Калі вы размаўляеце па тэлефоне з кімсці, каго вы НЕ ВЕДАЕЦЕ і каму НЕ ДАВЕРАЕЦЕ, і ён просіць вас выкарыстаць UptimeDesk і запусціць яго службу, не працягвайце і неадкладна адмяніце размову."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Абнавіце UptimeDesk Server Pro да версіі {} або новейшай!"),
        ...
        ("selinux_tip", "На вашай прыладзе ўключаны SELinux, што можа перашкаджаць правільнай працы UptimeDesk на кіруючым баку."),
        ...
        ("powered_by_me", "На аснове UptimeDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Дазволіць толькі падключэнне пры адкрытым акне UptimeDesk"),
        ...
        ("floating_window_tip", "Дапамагае падтрымліваць фонавую службу UptimeDesk"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Калі ласка, абнавіце кліент UptimeDesk да версіі {} або навейшай на аддаленым баку!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
