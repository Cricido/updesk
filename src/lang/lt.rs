...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Jūsų ID"),
        ("Copy", "Kopijuoti"),
        ("Quick Support", "Greita pagalba"),
        ("Ready for assistance", "Pasiruošęs pagalbai"),
        ("Protected connection (end-to-end encrypted)", "Apsaugotas ryšys (šifruotas nuo galo iki galo)"),
        ("Share your ID code with the technician", "Pasidalinkite savo ID kodu su techniku"),
        ("Connecting to server...", "Jungiamasi prie serverio..."),
        ("Online", "Prisijungęs"),
        ...
        ("connecting_status", "Prisijungiama prie UptimeDesk tinklo..."),
        ...
        ("install_tip", "Kai kuriais atvejais UAC gali priversti UptimeDesk netinkamai veikti nuotoliniame pagrindiniame kompiuteryje. Norėdami apeiti UAC, spustelėkite toliau esantį mygtuką, kad įdiegtumėte UptimeDesk į savo kompiuterį."),
        ("Click to upgrade", "Spustelėkite, jei norite atnaujinti"),
        ("Configure", "Konfigūruoti"),
        ("config_acc", "Norėdami nuotoliniu būdu valdyti darbalaukį, turite suteikti UptimeDesk \"prieigos\" leidimus"),
        ("config_screen", "Norėdami nuotoliniu būdu pasiekti darbalaukį, turite suteikti UptimeDesk leidimus \"ekrano kopija\""),
        ("Installing ...", "Diegiama ..."),
        ("Install", "Diegti"),
        ...
        ("install_daemon_tip", "Norėdami, kad UptimeDesk startuotų automatiškai, turite ją įdiegti"),
        ...
        ("android_input_permission_tip1", "Kad nuotolinis įrenginys galėtų valdyti Android įrenginį pele arba liesti, turite leisti UptimeDesk naudoti \"Prieinamumo\" paslaugą."),
        ("android_input_permission_tip2", "Eikite į kitą sistemos nustatymų puslapį, suraskite \"Įdiegtos paslaugos\" ir įgalinkite \"UptimeDesk įvestis\" paslaugą."),
        ...
        ("Turned off", "Išjungti"),
        ("Language", "Kalba"),
        ("Keep UptimeDesk background service", "Palikti UptimeDesk fonine paslauga"),
        ...
        ("Show UptimeDesk", "Rodyti UptimeDesk"),
        ...
        ("config_input", "Norėdami valdyti nuotolinį darbalaukį naudodami klaviatūrą, turite suteikti UptimeDesk leidimus \"Įvesties monitoringas\"."),
        ("config_microphone", "Norėdami kalbėtis su nuotoline puse, turite suteikti UptimeDesk leidimą \"Įrašyti garsą\"."),
        ...
        ("still_click_uac_tip", "Vis tiek reikia, kad nuotolinis vartotojas paleidžiant UptimeDesk UAC lange paspaustų \"OK\"."),
        ...
        ("verify_uptimedesk_password_tip", "Įveskite kliento UptimeDesk slaptažodį"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės UptimeDesk klientą į {} ar naujesnę versiją!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
