...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Teie ID"),
        ("Copy", "Kopeeri"),
        ("Quick Support", "Kiirtugi"),
        ("Ready for assistance", "Valmis abistama"),
        ("Protected connection (end-to-end encrypted)", "Kaitstud uhendus (otsast lopuni krüptitud)"),
        ("Share your ID code with the technician", "Jagage oma ID-koodi tehnikuga"),
        ("Connecting to server...", "Ühendamine serveriga..."),
        ("Online", "Võrgus"),
        ...
        ("connecting_status", "UptimeDeski võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa UptimeDesk mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et UptimeDesk oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb UptimeDeskile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb UptimeDeskile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma UptimeDeskile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [UptimeDesk Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep UptimeDesk background service", "Säilita UptimeDeski taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele UptimeDeski rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show UptimeDesk", "Kuva UptimeDesk"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma UptimeDeskile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma UptimeDeskile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud UptimeDeski kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_uptimedesk_password_tip", "Kinnita UptimeDeski parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul UptimeDeski kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Palun täienda UptimeDesk Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib UptimeDeskil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb UptimeDeskil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui UptimeDeski aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada UptimeDeski taustateenust."),
        ...
        ("About UptimeDesk", "UptimeDeski teave"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Täiendage UptimeDeski klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
