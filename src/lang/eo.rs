...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Via ID"),
        ("Copy", "Kopii"),
        ("Quick Support", "Rapida subteno"),
        ("Ready for assistance", "Preta helpi"),
        ("Protected connection (end-to-end encrypted)", "Protektita konekto (cifrita de fino al fino)"),
        ("Share your ID code with the technician", "Kunsigu vian ID-kodon kun la teknikisto"),
        ("Connecting to server...", "Konektante al servilo..."),
        ("Online", "Rete"),
        ("Offline", "Eksterrete"),
        ...
        ("connecting_status", "Konektante al la reto UptimeDesk..."),
        ...
        ("install_tip", "Vi ne uzas instalita versio. Pro limigoj pro UAC, kiel aparato kontrolata, en kelkaj kazoj, ne estos ebla kontroli la muson kaj klavaron aŭ registri la ekranon. Bonvolu alkliku la butonon malsupre por instali UptimeDesk sur la operaciumo por eviti la demando supre."),
        ("Click to upgrade", "Alklaki por plibonigi"),
        ("Configure", "Konfiguri"),
        ("config_acc", "Por uzi vian foran aparaton, bonvolu doni la permeson \"alirebleco\" al UptimeDesk."),
        ("config_screen", "Por uzi vian foran aparaton, bonvolu doni la permeson \"ekranregistrado\" al UptimeDesk."),
        ...
        ("android_input_permission_tip1", "Por ke fora aparato regu vian Android-aparaton per muso aŭ tuŝo, vi devas permesi al UptimeDesk uzi la servon \"Alirebleco\"."),
        ("android_input_permission_tip2", "Bonvolu iri al la sekva paĝo de sistemaj agordoj, trovi kaj eniri [Instatajn Servojn], ŝalti la servon [UptimeDesk Enigo]."),
        ...
        ("Language", "Lingvo"),
        ("Keep UptimeDesk background service", "Tenu UptimeDesk fonan servon"),
        ("Ignore Battery Optimizations", "Ignoru Bateria Optimumigojn"),
        ("android_open_battery_optimizations_tip", "Se vi volas malŝalti ĉi tiun funkcion, bonvolu iri al la sekva paĝo de agordoj de la aplikaĵo de UptimeDesk, trovi kaj eniri [Baterio], Malmarku [Senrestrikta]"),
