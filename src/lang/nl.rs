...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Jouw ID"),
        ("Copy", "Kopiëren"),
        ("Quick Support", "Snelle ondersteuning"),
        ("Ready for assistance", "Klaar voor hulp"),
        ("Protected connection (end-to-end encrypted)", "Beveiligde verbinding (end-to-end versleuteld)"),
        ("Share your ID code with the technician", "Deel uw ID-code met de technicus"),
        ("Connecting to server...", "Verbinding maken met server..."),
        ("Online", "Online"),
        ("Offline", "Offline"),
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het UptimeDesk netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer UptimeDesk op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u UptimeDesk toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u UptimeDesk toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u UptimeDesk toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [UptimeDesk Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep UptimeDesk background service", "UptimeDesk achtergronddienst behouden"),
        ...
        ("Show UptimeDesk", "Toon UptimeDesk"),
        ("This PC", "Deze PC"),
        ("or", "of"),
        ("Elevate", "Verhoog"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u UptimeDesk toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u UptimeDesk toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende UptimeDesk."),
        ...
        ("verify_uptimedesk_password_tip", "Bevestiging wachtwoord UptimeDesk"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om UptimeDesk te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Upgrade UptimeDesk Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor UptimeDesk mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("powered_by_me", "Werkt met Uptimedesk"),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het UptimeDesk-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt UptimeDesk op de achtergrond actief te houden"),
        ...
        ("About UptimeDesk", "Over UptimeDesk"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Upgrade de UptimeDesk client naar versie {} of nieuwer op de externe computer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standaard controleert UptimeDesk het certificaat van de server bij het gebruik van protocollen die TLS gebruiken. Wanneer deze optie is ingeschakeld, laat UptimeDesk verbindingen toe, zelfs als de verificatiestap mislukt."),
        ("Disable UDP", "UDP uitschakelen"),
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt UptimeDesk niet langer UDP 21116, maar TCP 21116."),
        ("server-oss-not-support-tip", "Opmerking: Deze functie is niet beschikbaar in de open-sourceversie van de UptimeDesk-server."),
