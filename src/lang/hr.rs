...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Vaš ID"),
        ("Copy", "Kopiraj"),
        ("Quick Support", "Brza podrška"),
        ("Ready for assistance", "Spreman za pomoc"),
        ("Protected connection (end-to-end encrypted)", "Zaštićena veza (šifrirana s kraja na kraj)"),
        ("Share your ID code with the technician", "Podijelite svoj ID kod s tehnicarom"),
        ("Connecting to server...", "Spajanje na poslužitelj..."),
        ("Online", "Na mrezi"),
        ("Offline", "Izvan mreze"),
        ...
        ("connecting_status", "Spajanje na UptimeDesk mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a UptimeDesk ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate UptimeDesk na sustav."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfiguracija"),
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, UptimeDesk-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, UptimeDesk-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti UptimeDesk-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [UptimeDesk Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep UptimeDesk background service", "Zadrži UptimeDesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje UptimeDesk aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show UptimeDesk", "Prikaži UptimeDesk"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti UptimeDesku dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti UptimeDesku \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog UptimeDeska."),
        ...
        ("verify_uptimedesk_password_tip", "Provjera lozinke za UptimeDesk"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete UptimeDesk, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Ažurirajte UptimeDesk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti UptimeDesk da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće UptimeDesk"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Molimo ažurirajte UptimeDesk klijent na verziju {} ili noviju na udaljenoj strani!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
