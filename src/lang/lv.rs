...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Jūsu ID"),
        ("Copy", "Kopet"),
        ("Quick Support", "Atrais atbalsts"),
        ("Ready for assistance", "Gatavs palīdzet"),
        ("Protected connection (end-to-end encrypted)", "Aizsargats savienojums (šifrets no gala lidz galam)"),
        ("Share your ID code with the technician", "Kopīgojiet savu ID kodu ar tehniki"),
        ("Connecting to server...", "Pieslegšanas serverim..."),
        ("Online", "Tiešsaiste"),
        ("Offline", "Bezsaiste"),
        ...
        ("connecting_status", "Notiek savienojuma izveide ar UptimeDesk tīklu..."),
        ...
        ("install_tip", "UAC dēļ UptimeDesk dažos gadījumos nevar pareizi darboties kā attālā puse. Lai izvairītos no UAC, lūdzu, noklikšķiniet uz tālāk esošās pogas, lai instalētu UptimeDesk sistēmā."),
        ("Click to upgrade", "Jaunināt"),
        ("Configure", "Konfigurēt"),
        ("config_acc", "Lai attālināti vadītu savu darbvirsmu, jums ir jāpiešķir UptimeDesk \"Pieejamība\" atļaujas."),
        ("config_screen", "Lai attālināti piekļūtu darbvirsmai, jums ir jāpiešķir UptimeDesk \"Ekrāna tveršana\" atļaujas."),
        ...
        ("android_input_permission_tip1", "Lai attālā ierīce varētu vadīt jūsu Android ierīci, izmantojot peli vai pieskārienu, jums ir jāatļauj UptimeDesk izmantot servisu \"Pieejamība\"."),
        ("android_input_permission_tip2", "Lūdzu, dodieties uz nākamo sistēmas iestatījumu lapu, atrodiet un atveriet [Instalētie pakalpojumi], ieslēdziet servisu [UptimeDesk Input]."),
        ...
        ("Turned off", "Izslēgts"),
        ("Language", "Valoda"),
        ("Keep UptimeDesk background service", "Saglabāt UptimeDesk fona servisu"),
        ("Ignore Battery Optimizations", "Ignorēt akumulatora optimizāciju"),
        ("android_open_battery_optimizations_tip", "Ja vēlaties atspējot šo funkciju, lūdzu, dodieties uz nākamo UptimeDesk lietojumprogrammas iestatījumu lapu, atrodiet un atveriet [Akumulators], noņemiet atzīmi no [Neierobežots]"),
        ...
        ("Show UptimeDesk", "Rādīt UptimeDesk"),
        ("This PC", "Šis dators"),
        ("or", "vai"),
        ("Elevate", "Pacelt"),
        ...
        ("config_input", "Lai vadītu attālo darbvirsmu ar tastatūru, jums ir jāpiešķir UptimeDesk \"Ievades uzraudzība\" atļaujas."),
        ("config_microphone", "Lai runātu attālināti, jums ir jāpiešķir UptimeDesk \"Ierakstīt audio\" atļaujas."),
        ...
        ("still_click_uac_tip", "Joprojām attālajam lietotājam ir jānoklikšķina uz Labi UAC logā, kurā darbojas UptimeDesk."),
        ...
        ("verify_uptimedesk_password_tip", "Pārbaudīt UptimeDesk paroli"),
        ...
        ("scam_text1", "Ja sarunājaties ar kādu, kuru nepazīstat un kurš ir lūdzis izmantot UptimeDesk, lai sāktu pakalpojumu, neturpiniet un nekavējoties nolieciet klausuli."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Lūdzu, jauniniet UptimeDesk Server Pro uz versiju {} vai jaunāku!"),
        ...
        ("selinux_tip", "Jūsu ierīcē ir iespējots SELinux, kas var neļaut UptimeDesk pareizi darboties kā kontrolētajai pusei."),
        ...
        ("powered_by_me", "Darbojas ar UptimeDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Atļaut savienojumu tikai tad, ja ir atvērts UptimeDesk logs"),
        ...
        ("floating_window_tip", "Tas palīdz uzturēt UptimeDesk fona servisu"),
        ...
        ("About UptimeDesk", "Par UptimeDesk"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Lūdzu, jauniniet attālās puses UptimeDesk klientu uz versiju {} vai jaunāku!"),
