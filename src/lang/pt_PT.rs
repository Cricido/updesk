...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Protected connection (end-to-end encrypted)", "Ligacao protegida (cifrada de ponta a ponta)"),
        ("Share your ID code with the technician", "Partilhe o seu codigo ID com o tecnico"),
        ...
        ("connecting_status", "A ligar à rede do UptimeDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o UptimeDesk não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o UptimeDesk no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao UptimeDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao UptimeDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o UptimeDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [UptimeDesk Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep UptimeDesk background service", "Manter o serviço UptimeDesk em funcionamento"),
