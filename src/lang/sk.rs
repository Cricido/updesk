...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Vaše ID"),
        ("Copy", "Kopirovat"),
        ("Quick Support", "Rychla podpora"),
        ("Ready for assistance", "Pripraveny na pomoc"),
        ("Protected connection (end-to-end encrypted)", "Chranene pripojenie (šifrované end-to-end)"),
        ("Share your ID code with the technician", "Zdieľajte svoj kod ID s technikom"),
        ("Connecting to server...", "Pripajanie k serveru..."),
        ("Online", "Online"),
        ("Offline", "Offline"),
        ...
        ("connecting_status", "Pripájam sa na UptimeDesk server..."),
        ...
        ("install_tip", "V niektorých prípadoch UptimeDesk nefunguje správne z dôvodu riadenia užívateľských oprávnení (UAC). Vyhnete sa tomu kliknutím na nižšie zobrazene tlačítko a nainštalovaním RuskDesk do systému."),
        ("Click to upgrade", "Kliknutím nainštalujete aktualizáciu"),
        ("Configure", "Nastaviť"),
        ("config_acc", "Aby bolo možné na diaľku ovládať vašu plochu, je potrebné aplikácii UptimeDesk udeliť práva \"Dostupnosť\"."),
        ("config_screen", "Aby bolo možné na diaľku sledovať vašu obrazovku, je potrebné aplikácii UptimeDesk udeliť práva \"Zachytávanie obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby bolo možné na diaľku ovládať vašu plochu pomocou myši alebo dotykov, je potrebné aplikácii UptimeDesk udeliť práva \"Dostupnosť\"."),
        ("android_input_permission_tip2", "Prejdite na stránku nastavení systému, nájdite a vstúpte do [Stiahnuté služby], zapnite [UptimeDesk Input] službu."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep UptimeDesk background service", "Ponechať službu UptimeDesk na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovať optimalizácie batérie"),
        ("android_open_battery_optimizations_tip", "Ak chcete túto funkciu vypnúť, prejdite na ďalšiu stránku nastavení UptimeDesku, vyhľadajte a zadajte položku [Batéria], zrušte začiarknutie položky [Neobmedzené]."),
        ...
        ("Show UptimeDesk", "Zobraziť UptimeDesk"),
        ...
        ("config_input", "Ak chcete ovládať vzdialenú plochu pomocou klávesnice, musíte udeliť oprávnenie UptimeDesk \"Sledovanie vstupu\"."),
        ("config_microphone", "Ak chcete hovoriť na diaľku, musíte UptimeDesku udeliť povolenie \"Nahrávať zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále sa vyžaduje, aby vzdialený používateľ klikol na tlačidlo OK v okne UAC spusteného programu UptimeDesk."),
        ...
        ("verify_uptimedesk_password_tip", "Overenie hesla UptimeDesk"),
        ...
        ("scam_text1", "Ak telefonujete s niekým, koho nepoznáte a komu nedôverujete a kto vás požiadal o použitie a spustenie aplikácie UptimeDesk, nepokračujte v hovore a okamžite zaveste."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Aktualizujte UptimeDesk Server Pro na verziu {} alebo novšiu!"),
        ...
        ("selinux_tip", "Na vašom zariadení je povolený SELinux, čo môže brániť správnemu spusteniu UptimeDesku ako spravovanej strany."),
        ...
        ("powered_by_me", "Poháňané aplikáciou UptimeDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Povoliť pripojenie iba vtedy, ak je otvorené okno aplikácie UptimeDesk"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu UptimeDesk na pozadí"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Aktualizujte klienta UptimeDesk na verziu {} alebo novšiu na vzdialenej strane!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
