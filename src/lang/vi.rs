...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "ID của bạn"),
        ("Copy", "Sao chép"),
        ("Quick Support", "Ho tro nhanh"),
        ("Ready for assistance", "San sang ho tro"),
        ("Protected connection (end-to-end encrypted)", "Ket noi duoc bao ve (ma hoa dau cuoi)"),
        ("Share your ID code with the technician", "Chia se ma ID cua ban voi ky thuat vien"),
        ("Connecting to server...", "Dang ket noi den may chu..."),
        ("Online", "Truc tuyen"),
        ("Offline", "Ngoai tuyen"),
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới UptimeDesk..."),
        ...
        ("install_tip", "Do cơ chế UAC, UptimeDesk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt UptimeDesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho UptimeDesk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho UptimeDesk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [UptimeDesk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep UptimeDesk background service", "Giữ dịch vụ UptimeDesk chạy nền"),
        ...
        ("Show UptimeDesk", "Hiện UptimeDesk"),
        ...
        ("verify_uptimedesk_password_tip", "Xác thực mật khẩu UptimeDesk"),
        ...
        ("scam_text2", "Chỉ sử dụng UptimeDesk với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ UptimeDesk mở"),
        ...
        ("floating_window_tip", "Giữ UptimeDesk trên cùng"),
        ...
        ("About UptimeDesk", "Về UptimeDesk"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
