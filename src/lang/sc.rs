...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Su ID"),
        ("Copy", "Copia"),
        ("Quick Support", "Assistentzia rapida"),
        ("Ready for assistance", "Prontu pro s'assistentzia"),
        ("Protected connection (end-to-end encrypted)", "Connessione protegida (cifradu)"),
        ("Share your ID code with the technician", "Cumpartzi su codice ID cun su tecnicu"),
        ("Connecting to server...", "Connessione a su serbidore..."),
        ("Online", "Online"),
        ("Offline", "Offline"),
        ...
        ("connecting_status", "Connessione a sa rete UptimeDesk..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), UptimeDesk diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare UptimeDesk a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a UptimeDesk su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a UptimeDesk su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a UptimeDesk de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada UptimeDesk]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep UptimeDesk background service", "Mantene su servìtziu de UptimeDesk in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione UptimeDesk, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("Show UptimeDesk", "Mustra UptimeDesk"),
        ("This PC", "Custu PC"),
        ("or", "O"),
        ("Elevate", "Cresche"),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a UptimeDesk sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a UptimeDesk."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de UptimeDesk."),
        ...
        ("verify_uptimedesk_password_tip", "Cunfirma sa crae de UptimeDesk"),
        ...
        ("Exit", "Essi dae UptimeDesk"),
        ("Open", "Aberi UptimeDesk"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare UptimeDesk e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Atualiza UptimeDesk Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de UptimeDesk comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae UptimeDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana UptimeDesk est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de UptimeDesk"),
        ...
        ("About UptimeDesk", "Informatziones subra de UptimeDesk"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Atualiza su cliente UptimeDesk remotu a sa versione {} o prus noa!"),
