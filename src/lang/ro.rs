...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "ID-ul dvs."),
        ("Copy", "Copiati"),
        ("Quick Support", "Asistenta rapida"),
        ("Ready for assistance", "Gata pentru asistenta"),
        ("Protected connection (end-to-end encrypted)", "Conexiune protejata (criptata end-to-end)"),
        ("Share your ID code with the technician", "Partajati codul dvs. ID cu tehnicianul"),
        ("Connecting to server...", "Conectare la server..."),
        ("Online", "Online"),
        ("Offline", "Offline"),
        ...
        ("connecting_status", "În curs de conectare la rețeaua UptimeDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca UptimeDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala UptimeDesk."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți UptimeDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți UptimeDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți UptimeDesk să utilize serviciul „Accesibilitate”."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [UptimeDesk Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep UptimeDesk background service", "Rulează serviciul UptimeDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației UptimeDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show UptimeDesk", "Afișează UptimeDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi UptimeDesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi UptimeDesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din UptimeDesk care rulează."),
        ...
        ("verify_uptimedesk_password_tip", "Verifică parola UptimeDesk"),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", ""),
