...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Ditt ID"),
        ("Copy", "Kopiera"),
        ("Quick Support", "Snabb support"),
        ("Ready for assistance", "Redo for assistans"),
        ("Protected connection (end-to-end encrypted)", "Skyddad anslutning (end-to-end krypterad)"),
        ("Share your ID code with the technician", "Dela din ID-kod med teknikern"),
        ...
        ("connecting_status", "Ansluter till UptimeDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte UptimeDesk fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera UptimeDesk på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge UptimeDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge UptimeDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [UptimeDesk Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep UptimeDesk background service", "Behåll UptimeDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa UptimeDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show UptimeDesk", "Visa UptimeDesk"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
