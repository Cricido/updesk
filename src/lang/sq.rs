...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "ID-ja juaj"),
        ("Copy", "Kopjo"),
        ("Quick Support", "Mbeshtetje e shpejte"),
        ("Ready for assistance", "Gati per ndihme"),
        ("Protected connection (end-to-end encrypted)", "Lidhje e mbrojtur (e enkriptuar)"),
        ("Share your ID code with the technician", "Ndajeni kodin tuaj ID me teknikun"),
        ("Connecting to server...", "Duke u lidhur me serverin..."),
        ("Online", "Online"),
        ("Offline", "Offline"),
        ...
        ("install_tip", "Për shkak të UAC, UptimeDesk nuk mund të punoj sic duhet si nje remote në distancë në disa raste. Për të shamngur UAC, ju lutem klikoni butonin më poshtë për të instaluar UptimeDesk në sistem."),
        ("Click to upgrade", "Klikoni për përmirësim"),
        ("Configure", "Koniguro"),
        ("config_acc", "Për të kontrolluar Desktopin tuaj nga distanca, duhet të jepni leje UptimeDesk \"Aksesueshmëri\"."),
        ("config_screen", "Për të aksesuar Desktopin tuaj nga distanca, duhet ti jepni lejet UptimeDesk \"Regjistrimin e ekranit\"."),
        ...
        ("android_input_permission_tip1", "Në mënyrë që një pajisje në distancë të kontrollojë pajisjen tuaj Android nëpërmjet mausit ose prekjes, duhet të lejoni UptimeDesk të përdorë shërbimin."),
        ("android_input_permission_tip2", "Ju lutemi shkoni në faqen tjetër të cilësimeve të sistemit, gjeni dhe shtypni [Shërbimet e Instaluara], aktivizoni shërbimin [UptimeDesk Input]"),
        ...
        ("Turned off", "I fikur"),
        ("Language", "Gjuha"),
        ("Keep UptimeDesk background service", "Mbaje shërbimin e sfondit të UptimeDesk"),
        ("Ignore Battery Optimizations", "Injoro optimizimet e baterisë"),
        ("android_open_battery_optimizations_tip", "Nëse dëshironi ta çaktivizoni këtë veçori, ju lutemi shkoni te faqja tjetër e cilësimeve të aplikacionit UptimeDesk, gjeni dhe shtypni [Batteri], hiqni zgjedhjen [Te pakufizuara]"),
        ("Start on boot", ""),
        ...
        ("Show UptimeDesk", "Shfaq UptimeDesk"),
        ("This PC", "Ky PC"),
        ("or", "ose"),
        ("Elevate", "Ngritja"),
