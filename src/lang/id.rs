...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "ID Anda"),
        ("Copy", "Salin"),
        ("Quick Support", "Dukungan Cepat"),
        ("Ready for assistance", "Siap untuk bantuan"),
        ("Protected connection (end-to-end encrypted)", "Koneksi terlindungi (terenkripsi ujung-ke-ujung)"),
        ("Share your ID code with the technician", "Bagikan kode ID Anda dengan teknisi"),
        ...
        ("connecting_status", "Menghubungkan ke UptimeDesk..."),
        ...
        ("install_tip", "Karena UAC, UptimeDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal UptimeDesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk UptimeDesk."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk UptimeDesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd UptimeDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input UptimeDesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep UptimeDesk background service", "Pertahankan UptimeDesk berjalan pada service background"),
        ...
        ("Show UptimeDesk", "Tampilkan UptimeDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada UptimeDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada UptimeDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC UptimeDesk yang sedang berjalan"),
        ...
        ("verify_uptimedesk_password_tip", "Verifikasi Kata Sandi UptimeDesk"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan UptimeDesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Silahkan perbarui UptimeDesk Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah UptimeDesk berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh UptimeDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela UptimeDesk sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service UptimeDesk agar tetap aktif"),
        ...
        ("About UptimeDesk", "Tentang UptimeDesk"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Silahkan perbarui aplikasi UptimeDesk ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
