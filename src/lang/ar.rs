...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "معرّفك"),
        ("Copy", "نسخ"),
        ("Quick Support", "دعم سريع"),
        ("Ready for assistance", "جاهز للمساعدة"),
        ("Protected connection (end-to-end encrypted)", "اتصال محمي (مشفّر من طرف إلى طرف)"),
        ("Share your ID code with the technician", "شارك رمز معرّفك مع الفني"),
        ("Connecting to server...", "جارٍ الاتصال بالخادم..."),
        ("Online", "متصل"),
        ("Offline", "غير متصل"),
        ...
        ("connecting_status", "جاري الاتصال بشبكة UptimeDesk..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. UptimeDesk قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت UptimeDesk في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح UptimeDesk اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح UptimeDesk اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ UptimeDesk باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [UptimeDesk Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep UptimeDesk background service", "ابق خدمة UptimeDesk تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق UptimeDesk, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show UptimeDesk", "عرض UptimeDesk"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من UptimeDesk اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح UptimeDesk اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في UptimeDesk الذي يعمل."),
        ...
        ("verify_uptimedesk_password_tip", "تحقق من كلمة مرور UptimeDesk"),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "ترقية خادم UptimeDesk Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع UptimeDesk"),
        ...
        ("About UptimeDesk", "حول UptimeDesk"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "ترقية عميل UptimeDesk البعيد إلى {}"),
