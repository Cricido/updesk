...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Ваш ID"),
        ("Copy", "Копіювати"),
        ("Quick Support", "Швидка підтримка"),
        ("Ready for assistance", "Готовий до допомоги"),
        ("Protected connection (end-to-end encrypted)", "Захищене зєднання (наскрізне шифрування)"),
        ("Share your ID code with the technician", "Поділіться кодом ID з технічним спеціалістом"),
        ...
        ("connecting_status", "Підключення до мережі UptimeDesk..."),
        ...
        ("install_tip", "Через UAC, в деяких випадках UptimeDesk може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення UptimeDesk в системі"),
        ("Click to upgrade", "Натисніть, щоб перевірити наявність оновлень"),
        ("Configure", "Налаштувати"),
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати UptimeDesk дозволи \"Спеціальні можливості\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці, вам необхідно надати UptimeDesk дозволи на \"Запис екрана\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або дотику, вам необхідно дозволити UptimeDesk використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Будь ласка, перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [UptimeDesk Input]."),
        ...
        ("Language", "Мова"),
        ("Keep UptimeDesk background service", "Зберегти фонову службу UptimeDesk"),
        ...
        ("Show UptimeDesk", "Показати UptimeDesk"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_input", "Для віддаленого керування віддаленою стільницею з клавіатури, вам необхідно надати UptimeDesk дозволи на \"Відстеження введення\""),
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати UptimeDesk дозвіл на \"Запис аудіо\""),
        ...
        ("verify_uptimedesk_password_tip", "Перевірте пароль UptimeDesk"),
        ...
        ("scam_text1", "Якщо ви розмовляєте по телефону з кимось, кого НЕ ЗНАЄТЕ чи кому НЕ ДОВІРЯЄТЕ, і ця особа хоче, щоб ви використали UptimeDesk та запустили службу, не робіть цього та негайно завершіть дзвінок."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Будь ласка, оновіть UptimeDesk Server Pro до версії {} чи новіше!"),
        ...
        ("selinux_tip", "SELinux увімкнено на вашому пристрої, що може ускладнити для іншої сторони віддалене керування за допомогою UptimeDesk."),
        ...
        ("powered_by_me", "На основі Uptimedesk"),
        ...
        ("allow-only-conn-window-open-tip", "Дозволяти підключення лише коли відкрите вікно UptimeDesk"),
        ...
        ("floating_window_tip", "Допомагає зберегти фонову службу Uptimedesk"),
        ...
        ("About UptimeDesk", "Про Uptimedesk"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Будь ласка, оновіть UptimeDesk клієнт на віддаленому пристрої до версії {} чи новіше!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
