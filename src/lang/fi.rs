...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Sinun ID"),
        ("Copy", "Kopioi"),
        ("Quick Support", "Pikatuki"),
        ("Ready for assistance", "Valmis avustamaan"),
        ("Protected connection (end-to-end encrypted)", "Suojattu yhteys (paasta paahan salattu)"),
        ("Share your ID code with the technician", "Jaa ID-koodisi teknikon kanssa"),
        ("Connecting to server...", "Yhdistetaan palvelimeen..."),
        ("Online", "Verkossa"),
        ("Offline", "Ei verkossa"),
        ...
        ("connecting_status", "Yhdistetään UptimeDesk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa UptimeDesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi UptimeDeskin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava UptimeDeskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava UptimeDeskille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten UptimeDesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota UptimeDeskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli UptimeDesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "UptimeDesk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa UptimeDeskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "UptimeDesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep UptimeDesk background service", "Pidä UptimeDeskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista UptimeDeskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show UptimeDesk", "Näytä UptimeDesk"),
        ...
        ("verify_uptimedesk_password_tip", "Vahvista UptimeDesk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "UptimeDesk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Päivitä UptimeDesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About UptimeDesk", "Tietoa UptimeDeskistä"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Päivitä etä-UptimeDesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
