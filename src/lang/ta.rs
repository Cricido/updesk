...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready for assistance", "உதவிக்கு தயார்"),
        ("Protected connection (end-to-end encrypted)", "பாதுகாக்கப்பட்ட இணைப்பு"),
        ("Share your ID code with the technician", "உங்கள் ஐடி குறியீட்டை பகிரவும்"),
        ("Connecting to server...", "சேவையகத்துடன் இணைக்கிறது..."),
        ("Online", "ஆன்லைன்"),
        ("Offline", "ஆஃப்லைன்"),
        ...
        ("android_input_permission_tip1", "UptimeDesk இந்த Android சாதனத்தை கட்டுப்படுத்த \"அணுகல் சேவைகள்\" அனுமதி தேவை."),
        ("android_input_permission_tip2", "சிஸ்டம் அமைப்புகளில் [நிறுவப்பட்ட சேவைகள்] கண்டுபிடித்து, UptimeDesk சேவை இயக்கவும்."),
        ...
        ("Language", "மொழி"),
        ("Keep UptimeDesk background service", "UptimeDesk பின்புல சேவையை வைத்திரு"),
        ("Ignore Battery Optimizations", "பேட்டரி மேம்படுத்தல்களை புறக்கணி"),
        ("android_open_battery_optimizations_tip", "UptimeDesk க்கு பேட்டரி மேம்படுத்தல் அணைக்க அமைப்புகளுக்கு செல்லவும்"),
        ...
        ("Show UptimeDesk", "UptimeDesk ஐ காட்டு"),
        ("This PC", "இந்த PC"),
        ("or", "அல்லது"),
        ("Elevate", "உயர்த்து"),
        ...
        ("verify_uptimedesk_password_tip", "uptimedesk_கடவுச்சொல்_சரிபார்ப்பு_குறிப்பு"),
        ...
        ("scam_text2", "UptimeDesk ஊழியர் இவ்வாறு தொடர்பு கொள்ள மாட்டார்கள்"),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "UptimeDesk Server Pro {} க்கு மேம்படுத்து"),
        ...
        ("selinux_tip", "SELinux இயக்கப்பட்டது, UptimeDesk அனுமதி வேண்டும்"),
        ...
        ("enable-2fa-desc", "UptimeDesk இரு காரணி அங்கீகாரம் ஆதரிக்கிறது"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "ரிமோட்_uptimedesk_கிளையன்டை_{}_மேம்படுத்து_குறிப்பு"),
