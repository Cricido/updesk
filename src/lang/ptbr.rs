...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Seu ID"),
        ("Copy", "Copiar"),
        ("Quick Support", "Suporte rapido"),
        ("Ready for assistance", "Pronto para assistencia"),
        ("Protected connection (end-to-end encrypted)", "Conexao protegida (criptografada de ponta a ponta)"),
        ("Share your ID code with the technician", "Compartilhe seu codigo ID com o tecnico"),
        ...
        ("connecting_status", "Conectando à rede do UptimeDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o UptimeDesk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o UptimeDesk no sistema."),
        ("Click to upgrade", "Clique para fazer o upgrade"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao UptimeDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao UptimeDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o UptimeDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [UptimeDesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep UptimeDesk background service", "Manter o serviço do UptimeDesk executando em segundo plano"),
        ...
        ("Show UptimeDesk", "Exibir UptimeDesk"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do UptimeDesk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do UptimeDesk."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do UptimeDesk."),
        ...
        ("verify_uptimedesk_password_tip", "Verifique a senha do UptimeDesk"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o UptimeDesk e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Atualize o UptimeDesk Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o UptimeDesk funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por UptimeDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do UptimeDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço UptimeDesk em segundo plano"),
        ...
        ("About UptimeDesk", "Sobre UptimeDesk"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Atualize o cliente UptimeDesk para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o UptimeDesk verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o UptimeDesk ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o UptimeDesk não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor UptimeDesk OSS não inclui este recurso."),
