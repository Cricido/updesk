...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Vaš ID"),
        ("Copy", "Kopiraj"),
        ("Quick Support", "Hitra podpora"),
        ("Ready for assistance", "Pripravljen za pomoc"),
        ("Protected connection (end-to-end encrypted)", "Zaščitena povezava (šifrirana od konca do konca)"),
        ("Share your ID code with the technician", "Delite svojo ID kodo s tehnikom"),
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem UptimeDesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, UptimeDesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate UptimeDesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate UptimeDesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno UptimeDesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »UptimeDesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep UptimeDesk background service", "Ohrani UptimeDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije UptimeDesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "UptimeDesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "UptimeDesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_uptimedesk_password_tip", "Preveri geslo za UptimeDesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite UptimeDesk, prekinite klic in program zaprite."),
        ("scam_text2", "UptimeDesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Prosimo, nadgradite UptimeDesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo UptimeDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno UptimeDeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri UptimeDesk storitvi v ozadju"),
        ...
        ("About UptimeDesk", "O UptimeDesku"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Prosimo, nadgradite UptimeDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
