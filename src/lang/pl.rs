...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Twoje ID"),
        ("Copy", "Kopiuj"),
        ("Quick Support", "Szybka pomoc"),
        ("Ready for assistance", "Gotowy do pomocy"),
        ("Protected connection (end-to-end encrypted)", "Chronione połączenie (szyfrowanie end-to-end)"),
        ("Share your ID code with the technician", "Udostępnij swój kod ID technikowi"),
        ...
        ("install_tip", "UptimeDesk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować UptimeDesk w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić UptimeDesk przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić UptimeDesk na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [UptimeDesk Input]."),
        ...
        ("Language", "Język"),
        ("Keep UptimeDesk background service", "Zachowaj usługę UptimeDesk w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji UptimeDesk, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show UptimeDesk", "Pokaż UptimeDesk"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji UptimeDesk uprawnień do \"Urządzeń Wejściowych\"."),
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać UptimeDesk uprawnienia do \"Nagrań audio\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z UptimeDesk w Twojej sieci."),
        ...
        ("verify_uptimedesk_password_tip", "Weryfikuj hasło UptimeDesk"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu UptimeDesk - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Proszę zaktualizować UptimeDesk Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu UptimeDesk po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez UptimeDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno UptimeDesk jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę UptimeDesk w tle"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Proszę zaktualizować zdalny klient UptimeDesk do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie UptimeDesk weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, UptimeDesk pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, UptimeDesk nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS UptimeDesk nie obsługuje tej funkcji."),
