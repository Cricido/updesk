...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "ה-ID שלך"),
        ("Copy", "העתק"),
        ("Quick Support", "תמיכה מהירה"),
        ("Ready for assistance", "מוכן לסיוע"),
        ("Protected connection (end-to-end encrypted)", "חיבור מוגן (מוצפן מקצה לקצה)"),
        ("Share your ID code with the technician", "שתף את קוד ה-ID שלך עם הטכנאי"),
        ...
        ("Ready", "מוכן"),
        ("Established", "מחובר"),
        ("connecting_status", "מתחבר לרשת UptimeDesk..."),
        ...
        ("install_tip", "בגלל UAC, UptimeDesk לא יכול לפעול כראוי כצד מרוחק בחלק מהמקרים. כדי להימנע מ-UAC, אנא לחץ על הכפתור למטה כדי להתקין את UptimeDesk במערכת."),
        ("Click to upgrade", "לחץ כדי לשדרג"),
        ("Configure", "הגדר"),
        ("config_acc", "כדי לשלוט מרחוק בשולחן העבודה שלך, עליך להעניק ל-UptimeDesk הרשאות \"נגישות\"."),
        ("config_screen", "כדי לגשת מרחוק לשולחן העבודה שלך, עליך להעניק ל-UptimeDesk הרשאות \"הקלטת מסך\"."),
        ("Installing ...", "מתקין ..."),
        ("Install", "התקן"),
        ("Installation", "התקנה"),
        ...
        ("android_input_permission_tip1", "כדי שמכשיר מרוחק יוכל לשלוט במכשיר האנדרואיד שלך באמצעות עכבר או מגע, עליך לאפשר ל-UptimeDesk להשתמש בשירות \"נגישות\"."),
        ("android_input_permission_tip2", "אנא עבור לדף הגדרות המערכת הבא, מצא והכנס ל[שירותים מותקנים], הפעל את שירות [UptimeDesk Input]."),
        ...
        ("Turned off", "מכובה"),
        ("Language", "שפה"),
        ("Keep UptimeDesk background service", "השאר את שירות הרקע של UptimeDesk פעיל"),
        ("Ignore Battery Optimizations", "התעלם מאופטימיזציות סוללה"),
        ("android_open_battery_optimizations_tip", "אם ברצונך לבטל תכונה זו, אנא עבור לדף ההגדרות של יישום UptimeDesk , מצא והיכנס ל[סוללה], ובטל את הסימון מ-[לא מוגבל]"),
        ...
        ("Show UptimeDesk", "הצג את UptimeDesk"),
        ("This PC", "מחשב זה"),
        ("or", "או"),
        ...
        ("config_input", "כדי לשלוט בשולחן העבודה המרוחק באמצעות מקלדת, עליך להעניק ל-UptimeDesk הרשאות \"מעקב קלט\"."),
        ("config_microphone", "כדי לדבר מרחוק, עליך להעניק ל-UptimeDesk הרשאות \"הקלטת שמע\"."),
        ...
        ("still_click_uac_tip", "עדיין נדרש מהמשתמש המרוחק לאשר את חלון ה-UAC של UptimeDesk"),
        ...
        ("verify_uptimedesk_password_tip", "אמת סיסמת UptimeDesk"),
        ...
        ("scam_text1", "אם אתה בשיחת טלפון עם מישהו שאינך מכיר ואינך סומך עליו שביקש ממך להשתמש ב-UptimeDesk ולהתחיל את השירות, אל תמשיך ונתק מיד."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "אנא שדרג את UptimeDesk Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("selinux_tip", "SELinux מופעל במכשיר שלך, מה שעלול למנוע מ-UptimeDesk לפעול כראוי כצד הנשלט."),
        ...
        ("About UptimeDesk", "אודות UptimeDesk"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "אנא שדרג את לקוח UptimeDesk לגרסה {} או חדשה יותר בצד המרוחק!"),
