...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Protected connection (end-to-end encrypted)", "Zaštićena veza (enkriptovana)"),
        ("Share your ID code with the technician", "Podelite ID kod sa tehnicarom"),
        ("Connecting to server...", "Povezivanje sa serverom..."),
        ("Online", "Na mrezi"),
        ("Offline", "Van mreze"),
        ...
        ("install_tip", "Zbog UAC UptimeDesk ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate UptimeDesk na sistem."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfigurisanje"),
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, UptimeDesk-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, UptimeDesk-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite UptimeDesk-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [UptimeDesk Input] servis."),
        ...
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje UptimeDesk aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ("Start on boot", ""),
        ...
        ("Show UptimeDesk", "Prikazi UptimeDesk"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
        ("Elevate", "Izdigni"),
