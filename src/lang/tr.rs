...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Kimliginiz"),
        ("Copy", "Kopyala"),
        ("Quick Support", "Hizli Destek"),
        ("Ready for assistance", "Yardima hazir"),
        ("Protected connection (end-to-end encrypted)", "Korumali baglanti (uctan uca sifreli)"),
        ("Share your ID code with the technician", "ID kodunuzu teknisyenle paylasin"),
        ("Connecting to server...", "Sunucuya baglanıyor..."),
        ("Online", "Çevrimici"),
        ("Offline", "Çevrimdışı"),
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, UptimeDesk bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, UptimeDesk'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ("Click to upgrade", "Yükseltmek için tıklayınız"),
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için UptimeDesk'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için UptimeDesk'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, UptimeDesk'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [UptimeDesk Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep UptimeDesk background service", "UptimeDesk arka plan hizmetini sürdürün"),
        ("Ignore Battery Optimizations", "Pil Optimizasyonlarını Yoksay"),
        ("android_open_battery_optimizations_tip", "Bu özelliği devre dışı bırakmak istiyorsanız lütfen bir sonraki UptimeDesk uygulama ayarları sayfasına gidin, [Pil] ögesini bulun ve girin, [Sınırsız] ögesinin işaretini kaldırın"),
        ...
        ("Show UptimeDesk", "UptimeDesk'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ("Elevate", "Yükseltme"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için UptimeDesk'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için UptimeDesk'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan UptimeDesk'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_uptimedesk_password_tip", "UptimeDesk parolasını doğrulayın"),
        ...
        ("scam_text1", "Eğer tanımadığınız ve güvenmediğiniz birisiyle telefonda konuşuyorsanız ve sizden UptimeDesk'i kullanmanızı ve hizmeti başlatmanızı istiyorsa devam etmeyin ve hemen telefonu kapatın."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Lütfen UptimeDesk Server Pro'yu {} veya daha yeni bir sürüme yükseltin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux etkin olduğundan, UptimeDesk'in kontrollü tarafta düzgün çalışmasını engelleyebilir."),
        ...
        ("powered_by_me", "UptimeDesk tarafından desteklenmektedir"),
        ...
        ("allow-only-conn-window-open-tip", "Yalnızca UptimeDesk penceresi açıksa bağlantıya izin ver"),
        ...
        ("floating_window_tip", "UptimeDesk arka plan hizmetini açık tutmaya yardımcı olur"),
        ...
        ("About UptimeDesk", "UptimeDesk Hakkında"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Lütfen uzak tarafta UptimeDesk istemcisini {} sürümüne veya daha yenisine güncelleyin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Varsayılan olarak, UptimeDesk sunucu sertifikasını TLS kullanarak protokoller için doğrular.\nBu seçenek etkinleştirildiğinde, doğrulama başarısızlığı durumunda UptimeDesk doğrulama adımını atlayarak işleme devam eder."),
        ("Disable UDP", "UDP'yi devre dışı bırak"),
        ("disable-udp-tip", "Yalnızca TCP kullanılıp kullanılmayacağını kontrol eder.\nBu seçenek etkinleştirildiğinde, UptimeDesk artık UDP 21116'yı kullanmayacak, bunun yerine TCP 21116 kullanılacaktır."),
        ("server-oss-not-support-tip", "NOT: UptimeDesk sunucu OSS'si bu özelliği içermemektedir."),
