...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Tu ID"),
        ("Copy", "Copiar"),
        ("Quick Support", "Soporte rapido"),
        ("Ready for assistance", "Listo para asistencia"),
        ("Protected connection (end-to-end encrypted)", "Conexion protegida (cifrado de extremo a extremo)"),
        ("Share your ID code with the technician", "Comparte tu codigo ID con el tecnico"),
        ...
        ("connecting_status", "Conexión a la red UptimeDesk en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que UptimeDesk no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar UptimeDesk a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a UptimeDesk de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a UptimeDesk de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que UptimeDesk use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [UptimeDesk Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep UptimeDesk background service", "Dejar UptimeDesk como Servicio en 2do plano"),
        ...
        ("Show UptimeDesk", "Mostrar UptimeDesk"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a UptimeDesk permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a UptimeDesk permisos de \"Grabar Audio\"."),
        ...
        ("verify_uptimedesk_password_tip", "Verificar la contraseña de UptimeDesk"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses UptimeDesk e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "¡Por favor, actualiza UptimeDesk Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que UptimeDesk no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de UptimeDesk"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de UptimeDesk de fondo"),
        ...
        ("About UptimeDesk", "Acerca de UptimeDesk"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Por favor, actualiza el cliente UptimeDesk a la versión {} o superior en el lado remoto"),
