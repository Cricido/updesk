...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your ID", "Il tuo ID"),
        ("Copy", "Copia"),
        ("Quick Support", "Assistenza rapida"),
        ("Ready for assistance", "Pronto per l'assistenza"),
        ("Protected connection (end-to-end encrypted)", "Connessione protetta (cifrata end-to-end)"),
        ("Share your ID code with the technician", "Condividi il tuo ID con il tecnico"),
        ("Connecting to server...", "Connessione al server..."),
        ("Assistance Mode", "Modalità Assistenza"),
        ("Back to full version", "Torna alla versione completa"),
        ("You will be notified when someone connects", "Riceverai una notifica quando qualcuno si collega"),
        ("Copy ID", "Copia ID"),
        ("Online", "Online"),
        ...
        ("connecting_status", "Connessione alla rete UptimeDesk..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), UptimeDesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare UptimeDesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a UptimeDesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a UptimeDesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a UptimeDesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [UptimeDesk Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep UptimeDesk background service", "Mantieni il servizio di UptimeDesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione UptimeDesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show UptimeDesk", "Visualizza UptimeDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a UptimeDesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a UptimeDesk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di UptimeDesk."),
        ...
        ("verify_uptimedesk_password_tip", "Conferma password UptimeDesk"),
        ...
        ("Exit", "Esci da UptimeDesk"),
        ("Open", "Apri UptimeDesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare UptimeDesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Aggiorna UptimeDesk Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di UptimeDesk come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da UptimeDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra UptimeDesk è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio Uptimedesk in background."),
        ...
        ("About UptimeDesk", "Info su UptimeDesk"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Aggiorna il client UptimeDesk remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, UptimeDesk verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, UptimeDesk salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, UptimeDesk non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server UptimeDesk non include questa funzionalità."),
