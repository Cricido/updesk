...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready for assistance", "Ready for assistance"),
        ("Protected connection (end-to-end encrypted)", "Protected connection (end-to-end encrypted)"),
        ("Share your ID code with the technician", "Share your ID code with the technician"),
        ("Connecting to server...", "Connecting to server..."),
        ("Assistance Mode", "Assistance Mode"),
        ("Back to full version", "Back to full version"),
        ("You will be notified when someone connects", "You will be notified when someone connects"),
        ("Copy ID", "Copy ID"),
        ("Online", "Online"),
        ("Offline", "Offline"),
        ("connecting_status", "Connecting to the UptimeDesk network..."),
        ...
        ("install_tip", "Due to UAC, UptimeDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install UptimeDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant UptimeDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant UptimeDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow UptimeDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [UptimeDesk Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next UptimeDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant UptimeDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant UptimeDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running UptimeDesk."),
        ...
        ("verify_uptimedesk_password_tip", "Verify UptimeDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use UptimeDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_uptimedesk_server_pro_to_{}_tip", "Please upgrade UptimeDesk Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent UptimeDesk from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by UptimeDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if UptimeDesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep UptimeDesk background service"),
        ...
        ("upgrade_remote_uptimedesk_client_to_{}_tip", "Please upgrade the UptimeDesk client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, UptimeDesk verifies the server certificate for protocols using TLS.\nWith this option enabled, UptimeDesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, UptimeDesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: UptimeDesk server OSS doesn't include this feature."),
