...
///
/// Note:
/// On linux, we use dbus to communicate multiple uptimedesk process.
...
const DBUS_NAME: &str = "org.rustdesk.uptimedesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "UptimeDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.rustdesk.uptimedesk /dbus org.rustdesk.rustdesk.NewConnection string:'PEER_ID'`
