# Bidrag til UptimeDesk

UptimeDesk er åpene for bidrag fra alle. Her er reglene for de som har lyst til å
hjelpe oss:

## Bidrag

Bidrag til UptimeDesk eller deres avhengigheter burde være i form av GitHub pull requests.
...
UptimeDesk bidragere burker [Discord](https://discord.gg/nDceKgxnkV).
